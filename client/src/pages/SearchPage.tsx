...
function SearchPage() {
  ...
  // Filter branch checklist by search query
    ...
    <div className="min-h-screen bg-slate-50 text-slate-800 font-sans pb-16">
      ...
      <div className="max-w-7xl mx-auto px-4 -mt-8">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
          ...
          {/* Left Column: Search Form and Branch Filter */}
          <div className="lg:col-span-1 flex flex-col gap-6">
            ...
            <div className="bg-white rounded-3xl shadow-xl border border-slate-100 p-6 flex flex-col gap-4">
              ...
              {/* Custom Min/Max Rank Inputs (Visible only when 'custom' is selected) */}
              {rankRange === "custom" && (
            ...
            <div className="bg-white rounded-3xl shadow-xl border border-slate-100 p-6 flex flex-col gap-4">
              ...
              <div className="max-h-60 overflow-y-auto border border-slate-150 rounded-2xl p-3 flex flex-col gap-2 bg-slate-50/50 scrollbar-thin">
                {filteredBranches.length > 0 ? (
                  filteredBranches.map((branchName) => (
                    <label
                      key={branchName}
                      className="flex items-start gap-2.5 px-2.5 py-2 hover:bg-white rounded-lg cursor-pointer transition-all border border-transparent hover:border-slate-100"
                    >
                      <input
                        type="checkbox"
          ...
          {/* Right Column: Statistics and College Results List */}
                      ...
                      >
                        <div className="flex flex-col md:flex-row md:justify-between md:items-center gap-4">
                          ...
                          <div className="flex-1">
                            ...
                            <p className="text-sm font-semibold text-slate-500 mt-1.5 flex items-center gap-1.5">
                          ...
                          <div className="flex md:flex-col items-center md:items-end justify-between md:justify-center border-t md:border-t-0 border-slate-100 pt-3 md:pt-0 gap-2 min-w-[160px]">
                            ...
                            {/* Status Pills */}
                            <span
                              className={`px-3.5 py-1.5 rounded-full text-xs font-bold uppercase tracking-wider shadow-sm border
                                ${
                                  item.status === "SAFE"
